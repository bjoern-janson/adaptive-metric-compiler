...
&
K =
-\frac{d\,D_{\text{KL}}(P_{\text{true}}\|P_{\text{model}})}{dt}
\\[1.5em]
...
=
\frac{
\Delta\Omega_{\text{viable}}(M_Q\rightarrow M_Q')
}
{
C_{\text{search}}(M_Q\rightarrow M_Q')
}
\]
